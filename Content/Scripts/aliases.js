...
try { let fnprepatch_639 = PythonScriptLibrary.prototype.ExecutePythonCommandEx;PythonScriptLibrary.prototype.ExecutePythonCommandEx = function (PythonCommand, CommandResult, LogOutput, ExecutionMode = "ExecuteFile", FileExecutionScope = "Private") { return fnprepatch_639.call(this, PythonCommand, CommandResult, LogOutput, ExecutionMode, FileExecutionScope) }; } catch (e) {};
...
try { let fnprepatch_640 = MagicLeapHandTrackingFunctionLibrary.prototype.SetConfiguration;MagicLeapHandTrackingFunctionLibrary.prototype.SetConfiguration = function (StaticGesturesToActivate, KeypointsFilterLevel = "NoFilter", GestureFilterLevel = "NoFilter", HandSwitchingFilterLevel = "NoFilter", bTrackingEnabled = true) { return fnprepatch_640.call(this, StaticGesturesToActivate, KeypointsFilterLevel, GestureFilterLevel, HandSwitchingFilterLevel, bTrackingEnabled) }; } catch (e) {};
...
try { let fnprepatch_641 = AutoSettingWidget.prototype.ApplySettingValue;AutoSettingWidget.prototype.ApplySettingValue = function (Value, bSaveIfPossible = true) { return fnprepatch_641.call(this, Value, bSaveIfPossible) }; } catch (e) {};
try { let fnprepatch_642 = InputMappingManager.prototype.AddPlayerAxisOverrideStatic;InputMappingManager.prototype.AddPlayerAxisOverrideStatic = function (Player, NewMapping, MappingGroup, bAnyKeyGroup = false) { return fnprepatch_642.call(this, Player, NewMapping, MappingGroup, bAnyKeyGroup) }; } catch (e) {};
try { let fnprepatch_643 = InputMappingManager.prototype.AddPlayerAxisOverride;InputMappingManager.prototype.AddPlayerAxisOverride = function (Player, NewMapping, MappingGroup, bAnyKeyGroup = false) { return fnprepatch_643.call(this, Player, NewMapping, MappingGroup, bAnyKeyGroup) }; } catch (e) {};
try { let fnprepatch_644 = InputMappingManager.prototype.AddPlayerActionOverrideStatic;InputMappingManager.prototype.AddPlayerActionOverrideStatic = function (Player, NewMapping, MappingGroup, bAnyKeyGroup = false) { return fnprepatch_644.call(this, Player, NewMapping, MappingGroup, bAnyKeyGroup) }; } catch (e) {};
try { let fnprepatch_645 = InputMappingManager.prototype.AddPlayerActionOverride;InputMappingManager.prototype.AddPlayerActionOverride = function (Player, NewMapping, MappingGroup, bAnyKeyGroup = false) { return fnprepatch_645.call(this, Player, NewMapping, MappingGroup, bAnyKeyGroup) }; } catch (e) {};
...
try { let fnprepatch_646 = SettingContainerUtils.prototype.SaveChildSettings;SettingContainerUtils.prototype.SaveChildSettings = function (UserWidget, Parent = undefined) { return fnprepatch_646.call(this, UserWidget, Parent) }; } catch (e) {};
try { let fnprepatch_647 = SettingContainerUtils.prototype.GetChildSettings;SettingContainerUtils.prototype.GetChildSettings = function (UserWidget, Parent = undefined) { return fnprepatch_647.call(this, UserWidget, Parent) }; } catch (e) {};
try { let fnprepatch_648 = SettingContainerUtils.prototype.DoesAnyChildSettingHaveUnsavedChange;SettingContainerUtils.prototype.DoesAnyChildSettingHaveUnsavedChange = function (UserWidget, Parent = undefined) { return fnprepatch_648.call(this, UserWidget, Parent) }; } catch (e) {};
try { let fnprepatch_649 = SettingContainerUtils.prototype.DoesAnyChildSettingHaveUnappliedChange;SettingContainerUtils.prototype.DoesAnyChildSettingHaveUnappliedChange = function (UserWidget, Parent = undefined) { return fnprepatch_649.call(this, UserWidget, Parent) }; } catch (e) {};
try { let fnprepatch_650 = SettingContainerUtils.prototype.CancelChildSettings;SettingContainerUtils.prototype.CancelChildSettings = function (UserWidget, Parent = undefined) { return fnprepatch_650.call(this, UserWidget, Parent) }; } catch (e) {};
try { let fnprepatch_651 = SettingContainerUtils.prototype.ApplyChildSettings;SettingContainerUtils.prototype.ApplyChildSettings = function (UserWidget, Parent = undefined) { return fnprepatch_651.call(this, UserWidget, Parent) }; } catch (e) {};
try { let fnprepatch_652 = SettingsManager.prototype.GetValue;SettingsManager.prototype.GetValue = function (Key, bPreferConfigValue = false) { return fnprepatch_652.call(this, Key, bPreferConfigValue) }; } catch (e) {};
...
try { let fnprepatch_654 = JavascriptContext.prototype.RunScript;JavascriptContext.prototype.RunScript = function (Script, bOutput = true) { return fnprepatch_654.call(this, Script, bOutput) }; } catch (e) {};
try { let fnprepatch_655 = JavascriptContext.prototype.CreateInspector;JavascriptContext.prototype.CreateInspector = function (Port = 9229) { return fnprepatch_655.call(this, Port) }; } catch (e) {};
try { let fnprepatch_656 = JavascriptLibrary.prototype.DeleteFile;JavascriptLibrary.prototype.DeleteFile = function (Filename, ReadOnly = false) { return fnprepatch_656.call(this, Filename, ReadOnly) }; } catch (e) {};
try { let fnprepatch_657 = JavascriptLibrary.prototype.CreateSocket;JavascriptLibrary.prototype.CreateSocket = function (SocketType, Description, bForceUDP = false) { return fnprepatch_657.call(this, SocketType, Description, bForceUDP) }; } catch (e) {};
try { let fnprepatch_658 = JavascriptProcess.prototype.Terminate;JavascriptProcess.prototype.Terminate = function (KillTree = false) { return fnprepatch_658.call(this, KillTree) }; } catch (e) {};
try { let fnprepatch_659 = JavascriptUMGLibrary.prototype.AddWindow;JavascriptUMGLibrary.prototype.AddWindow = function (NewWindow, bShowImmediately = true) { return fnprepatch_659.call(this, NewWindow, bShowImmediately) }; } catch (e) {};
try { let fnprepatch_660 = AbilitySystemBlueprintLibrary.prototype.MakeSpecHandle;AbilitySystemBlueprintLibrary.prototype.MakeSpecHandle = function (InGameplayEffect, InInstigator, InEffectCauser, InLevel = 1) { return fnprepatch_660.call(this, InGameplayEffect, InInstigator, InEffectCauser, InLevel) }; } catch (e) {};
...
try { let fnprepatch_661 = AbilitySystemComponent.prototype.TryActivateAbilityByClass;AbilitySystemComponent.prototype.TryActivateAbilityByClass = function (InAbilityToActivate, bAllowRemoteActivation = true) { return fnprepatch_661.call(this, InAbilityToActivate, bAllowRemoteActivation) }; } catch (e) {};
try { let fnprepatch_662 = AbilitySystemComponent.prototype.TryActivateAbilitiesByTag;AbilitySystemComponent.prototype.TryActivateAbilitiesByTag = function (GameplayTagContainer, bAllowRemoteActivation = true) { return fnprepatch_662.call(this, GameplayTagContainer, bAllowRemoteActivation) }; } catch (e) {};
try { let fnprepatch_663 = AbilitySystemComponent.prototype.RemoveActiveGameplayEffectBySourceEffect;AbilitySystemComponent.prototype.RemoveActiveGameplayEffectBySourceEffect = function (GameplayEffect, InstigatorAbilitySystemComponent, StacksToRemove = -1) { return fnprepatch_663.call(this, GameplayEffect, InstigatorAbilitySystemComponent, StacksToRemove) }; } catch (e) {};
try { let fnprepatch_664 = AbilitySystemComponent.prototype.RemoveActiveGameplayEffect;AbilitySystemComponent.prototype.RemoveActiveGameplayEffect = function (Handle, StacksToRemove = -1) { return fnprepatch_664.call(this, Handle, StacksToRemove) }; } catch (e) {};
try { let fnprepatch_665 = AbilitySystemComponent.prototype.GetGameplayEffectCount;AbilitySystemComponent.prototype.GetGameplayEffectCount = function (SourceGameplayEffect, OptionalInstigatorFilterComponent, bEnforceOnGoingCheck = true) { return fnprepatch_665.call(this, SourceGameplayEffect, OptionalInstigatorFilterComponent, bEnforceOnGoingCheck) }; } catch (e) {};
...
try { let fnprepatch_666 = AbilityTask_PlayMontageAndWait.prototype.CreatePlayMontageAndWaitProxy;AbilityTask_PlayMontageAndWait.prototype.CreatePlayMontageAndWaitProxy = function (OwningAbility, TaskInstanceName, MontageToPlay, Rate = 1, StartSection = "None", bStopWhenAbilityEnds = true, AnimRootMotionTranslationScale = 1) { return fnprepatch_666.call(this, OwningAbility, TaskInstanceName, MontageToPlay, Rate, StartSection, bStopWhenAbilityEnds, AnimRootMotionTranslationScale) }; } catch (e) {};
...
try { let fnprepatch_667 = AbilityTask_StartAbilityState.prototype.StartAbilityState;AbilityTask_StartAbilityState.prototype.StartAbilityState = function (OwningAbility, StateName, bEndCurrentState = true) { return fnprepatch_667.call(this, OwningAbility, StateName, bEndCurrentState) }; } catch (e) {};
try { let fnprepatch_668 = AbilityTask_VisualizeTargeting.prototype.VisualizeTargetingUsingActor;AbilityTask_VisualizeTargeting.prototype.VisualizeTargetingUsingActor = function (OwningAbility, TargetActor, TaskInstanceName, Duration = -1) { return fnprepatch_668.call(this, OwningAbility, TargetActor, TaskInstanceName, Duration) }; } catch (e) {};
try { let fnprepatch_669 = AbilityTask_VisualizeTargeting.prototype.VisualizeTargeting;AbilityTask_VisualizeTargeting.prototype.VisualizeTargeting = function (OwningAbility, Class, TaskInstanceName, Duration = -1) { return fnprepatch_669.call(this, OwningAbility, Class, TaskInstanceName, Duration) }; } catch (e) {};
try { let fnprepatch_670 = AbilityTask_WaitAbilityActivate.prototype.WaitForAbilityActivateWithTagRequirements;AbilityTask_WaitAbilityActivate.prototype.WaitForAbilityActivateWithTagRequirements = function (OwningAbility, TagRequirements, IncludeTriggeredAbilities = false, TriggerOnce = true) { return fnprepatch_670.call(this, OwningAbility, TagRequirements, IncludeTriggeredAbilities, TriggerOnce) }; } catch (e) {};
try { let fnprepatch_671 = AbilityTask_WaitAbilityActivate.prototype.WaitForAbilityActivate_Query;AbilityTask_WaitAbilityActivate.prototype.WaitForAbilityActivate_Query = function (OwningAbility, Query, IncludeTriggeredAbilities = false, TriggerOnce = true) { return fnprepatch_671.call(this, OwningAbility, Query, IncludeTriggeredAbilities, TriggerOnce) }; } catch (e) {};
try { let fnprepatch_672 = AbilityTask_WaitAbilityActivate.prototype.WaitForAbilityActivate;AbilityTask_WaitAbilityActivate.prototype.WaitForAbilityActivate = function (OwningAbility, WithTag, WithoutTag, IncludeTriggeredAbilities = false, TriggerOnce = true) { return fnprepatch_672.call(this, OwningAbility, WithTag, WithoutTag, IncludeTriggeredAbilities, TriggerOnce) }; } catch (e) {};
try { let fnprepatch_673 = AbilityTask_WaitAbilityCommit.prototype.WaitForAbilityCommit_Query;AbilityTask_WaitAbilityCommit.prototype.WaitForAbilityCommit_Query = function (OwningAbility, Query, TriggerOnce = true) { return fnprepatch_673.call(this, OwningAbility, Query, TriggerOnce) }; } catch (e) {};
try { let fnprepatch_674 = AbilityTask_WaitAbilityCommit.prototype.WaitForAbilityCommit;AbilityTask_WaitAbilityCommit.prototype.WaitForAbilityCommit = function (OwningAbility, WithTag, WithoutTage, TriggerOnce = true) { return fnprepatch_674.call(this, OwningAbility, WithTag, WithoutTage, TriggerOnce) }; } catch (e) {};
...
try { let fnprepatch_675 = AbilityTask_WaitAttributeChange.prototype.WaitForAttributeChangeWithComparison;AbilityTask_WaitAttributeChange.prototype.WaitForAttributeChangeWithComparison = function (OwningAbility, InAttribute, InWithTag, InWithoutTag, InComparisonType, InComparisonValue, TriggerOnce = true, OptionalExternalOwner = undefined) { return fnprepatch_675.call(this, OwningAbility, InAttribute, InWithTag, InWithoutTag, InComparisonType, InComparisonValue, TriggerOnce, OptionalExternalOwner) }; } catch (e) {};
try { let fnprepatch_676 = AbilityTask_WaitAttributeChange.prototype.WaitForAttributeChange;AbilityTask_WaitAttributeChange.prototype.WaitForAttributeChange = function (OwningAbility, Attribute, WithSrcTag, WithoutSrcTag, TriggerOnce = true, OptionalExternalOwner = undefined) { return fnprepatch_676.call(this, OwningAbility, Attribute, WithSrcTag, WithoutSrcTag, TriggerOnce, OptionalExternalOwner) }; } catch (e) {};
try { let fnprepatch_677 = AbilityTask_WaitAttributeChangeRatioThreshold.prototype.WaitForAttributeChangeRatioThreshold;AbilityTask_WaitAttributeChangeRatioThreshold.prototype.WaitForAttributeChangeRatioThreshold = function (OwningAbility, AttributeNumerator, AttributeDenominator, ComparisonType, ComparisonValue, bTriggerOnce, OptionalExternalOwner = undefined) { return fnprepatch_677.call(this, OwningAbility, AttributeNumerator, AttributeDenominator, ComparisonType, ComparisonValue, bTriggerOnce, OptionalExternalOwner) }; } catch (e) {};
try { let fnprepatch_678 = AbilityTask_WaitAttributeChangeThreshold.prototype.WaitForAttributeChangeThreshold;AbilityTask_WaitAttributeChangeThreshold.prototype.WaitForAttributeChangeThreshold = function (OwningAbility, Attribute, ComparisonType, ComparisonValue, bTriggerOnce, OptionalExternalOwner = undefined) { return fnprepatch_678.call(this, OwningAbility, Attribute, ComparisonType, ComparisonValue, bTriggerOnce, OptionalExternalOwner) }; } catch (e) {};
...
try { let fnprepatch_679 = AbilityTask_WaitGameplayEffectApplied_Self.prototype.WaitGameplayEffectAppliedToSelf_Query;AbilityTask_WaitGameplayEffectApplied_Self.prototype.WaitGameplayEffectAppliedToSelf_Query = function (OwningAbility, SourceFilter, SourceTagQuery, TargetTagQuery, TriggerOnce = false, OptionalExternalOwner = undefined, ListenForPeriodicEffect = false) { return fnprepatch_679.call(this, OwningAbility, SourceFilter, SourceTagQuery, TargetTagQuery, TriggerOnce, OptionalExternalOwner, ListenForPeriodicEffect) }; } catch (e) {};
try { let fnprepatch_680 = AbilityTask_WaitGameplayEffectApplied_Self.prototype.WaitGameplayEffectAppliedToSelf;AbilityTask_WaitGameplayEffectApplied_Self.prototype.WaitGameplayEffectAppliedToSelf = function (OwningAbility, SourceFilter, SourceTagRequirements, TargetTagRequirements, TriggerOnce = false, OptionalExternalOwner = undefined, ListenForPeriodicEffect = false) { return fnprepatch_680.call(this, OwningAbility, SourceFilter, SourceTagRequirements, TargetTagRequirements, TriggerOnce, OptionalExternalOwner, ListenForPeriodicEffect) }; } catch (e) {};
try { let fnprepatch_681 = AbilityTask_WaitGameplayEffectApplied_Target.prototype.WaitGameplayEffectAppliedToTarget_Query;AbilityTask_WaitGameplayEffectApplied_Target.prototype.WaitGameplayEffectAppliedToTarget_Query = function (OwningAbility, SourceFilter, SourceTagQuery, TargetTagQuery, TriggerOnce = false, OptionalExternalOwner = undefined, ListenForPeriodicEffect = false) { return fnprepatch_681.call(this, OwningAbility, SourceFilter, SourceTagQuery, TargetTagQuery, TriggerOnce, OptionalExternalOwner, ListenForPeriodicEffect) }; } catch (e) {};
try { let fnprepatch_682 = AbilityTask_WaitGameplayEffectApplied_Target.prototype.WaitGameplayEffectAppliedToTarget;AbilityTask_WaitGameplayEffectApplied_Target.prototype.WaitGameplayEffectAppliedToTarget = function (OwningAbility, TargetFilter, SourceTagRequirements, TargetTagRequirements, TriggerOnce = false, OptionalExternalOwner = undefined, ListenForPeriodicEffects = false) { return fnprepatch_682.call(this, OwningAbility, TargetFilter, SourceTagRequirements, TargetTagRequirements, TriggerOnce, OptionalExternalOwner, ListenForPeriodicEffects) }; } catch (e) {};
try { let fnprepatch_683 = AbilityTask_WaitGameplayEffectBlockedImmunity.prototype.WaitGameplayEffectBlockedByImmunity;AbilityTask_WaitGameplayEffectBlockedImmunity.prototype.WaitGameplayEffectBlockedByImmunity = function (OwningAbility, SourceTagRequirements, TargetTagRequirements, OptionalExternalTarget = undefined, OnlyTriggerOnce = false) { return fnprepatch_683.call(this, OwningAbility, SourceTagRequirements, TargetTagRequirements, OptionalExternalTarget, OnlyTriggerOnce) }; } catch (e) {};
try { let fnprepatch_684 = AbilityTask_WaitGameplayEvent.prototype.WaitGameplayEvent;AbilityTask_WaitGameplayEvent.prototype.WaitGameplayEvent = function (OwningAbility, EventTag, OptionalExternalTarget = undefined, OnlyTriggerOnce = false, OnlyMatchExact = true) { return fnprepatch_684.call(this, OwningAbility, EventTag, OptionalExternalTarget, OnlyTriggerOnce, OnlyMatchExact) }; } catch (e) {};
try { let fnprepatch_685 = AbilityTask_WaitGameplayTagAdded.prototype.WaitGameplayTagAdd;AbilityTask_WaitGameplayTagAdded.prototype.WaitGameplayTagAdd = function (OwningAbility, Tag, InOptionalExternalTarget = undefined, OnlyTriggerOnce = false) { return fnprepatch_685.call(this, OwningAbility, Tag, InOptionalExternalTarget, OnlyTriggerOnce) }; } catch (e) {};
try { let fnprepatch_686 = AbilityTask_WaitGameplayTagRemoved.prototype.WaitGameplayTagRemove;AbilityTask_WaitGameplayTagRemoved.prototype.WaitGameplayTagRemove = function (OwningAbility, Tag, InOptionalExternalTarget = undefined, OnlyTriggerOnce = false) { return fnprepatch_686.call(this, OwningAbility, Tag, InOptionalExternalTarget, OnlyTriggerOnce) }; } catch (e) {};
try { let fnprepatch_687 = AbilityTask_WaitInputPress.prototype.WaitInputPress;AbilityTask_WaitInputPress.prototype.WaitInputPress = function (OwningAbility, bTestAlreadyPressed = false) { return fnprepatch_687.call(this, OwningAbility, bTestAlreadyPressed) }; } catch (e) {};
try { let fnprepatch_688 = AbilityTask_WaitInputRelease.prototype.WaitInputRelease;AbilityTask_WaitInputRelease.prototype.WaitInputRelease = function (OwningAbility, bTestAlreadyReleased = false) { return fnprepatch_688.call(this, OwningAbility, bTestAlreadyReleased) }; } catch (e) {};
...
try { let fnprepatch_689 = GameplayAbility.prototype.MontageStop;GameplayAbility.prototype.MontageStop = function (OverrideBlendOutTime = -1) { return fnprepatch_689.call(this, OverrideBlendOutTime) }; } catch (e) {};
try { let fnprepatch_690 = GameplayAbility.prototype.MakeOutgoingGameplayEffectSpec;GameplayAbility.prototype.MakeOutgoingGameplayEffectSpec = function (GameplayEffectClass, Level = 1) { return fnprepatch_690.call(this, GameplayEffectClass, Level) }; } catch (e) {};
try { let fnprepatch_691 = GameplayAbility.prototype.K2_CommitAbilityCost;GameplayAbility.prototype.K2_CommitAbilityCost = function (BroadcastCommitEvent = false) { return fnprepatch_691.call(this, BroadcastCommitEvent) }; } catch (e) {};
try { let fnprepatch_692 = GameplayAbility.prototype.K2_CommitAbilityCooldown;GameplayAbility.prototype.K2_CommitAbilityCooldown = function (BroadcastCommitEvent = false, ForceCooldown = false) { return fnprepatch_692.call(this, BroadcastCommitEvent, ForceCooldown) }; } catch (e) {};
try { let fnprepatch_693 = GameplayAbility.prototype.K2_AddGameplayCueWithParams;GameplayAbility.prototype.K2_AddGameplayCueWithParams = function (GameplayCueTag, GameplayCueParameter, bRemoveOnAbilityEnd = true) { return fnprepatch_693.call(this, GameplayCueTag, GameplayCueParameter, bRemoveOnAbilityEnd) }; } catch (e) {};
try { let fnprepatch_694 = GameplayAbility.prototype.K2_AddGameplayCue;GameplayAbility.prototype.K2_AddGameplayCue = function (GameplayCueTag, Context, bRemoveOnAbilityEnd = true) { return fnprepatch_694.call(this, GameplayCueTag, Context, bRemoveOnAbilityEnd) }; } catch (e) {};
try { let fnprepatch_695 = GameplayAbility.prototype.BP_RemoveGameplayEffectFromOwnerWithHandle;GameplayAbility.prototype.BP_RemoveGameplayEffectFromOwnerWithHandle = function (Handle, StacksToRemove = -1) { return fnprepatch_695.call(this, Handle, StacksToRemove) }; } catch (e) {};
try { let fnprepatch_696 = GameplayAbility.prototype.BP_RemoveGameplayEffectFromOwnerWithGrantedTags;GameplayAbility.prototype.BP_RemoveGameplayEffectFromOwnerWithGrantedTags = function (WithGrantedTags, StacksToRemove = -1) { return fnprepatch_696.call(this, WithGrantedTags, StacksToRemove) }; } catch (e) {};
try { let fnprepatch_697 = GameplayAbility.prototype.BP_RemoveGameplayEffectFromOwnerWithAssetTags;GameplayAbility.prototype.BP_RemoveGameplayEffectFromOwnerWithAssetTags = function (WithAssetTags, StacksToRemove = -1) { return fnprepatch_697.call(this, WithAssetTags, StacksToRemove) }; } catch (e) {};
try { let fnprepatch_698 = GameplayAbility.prototype.BP_ApplyGameplayEffectToTarget;GameplayAbility.prototype.BP_ApplyGameplayEffectToTarget = function (TargetData, GameplayEffectClass, GameplayEffectLevel = 1, Stacks = 1) { return fnprepatch_698.call(this, TargetData, GameplayEffectClass, GameplayEffectLevel, Stacks) }; } catch (e) {};
try { let fnprepatch_699 = GameplayAbility.prototype.BP_ApplyGameplayEffectToOwner;GameplayAbility.prototype.BP_ApplyGameplayEffectToOwner = function (GameplayEffectClass, GameplayEffectLevel = 1, Stacks = 1) { return fnprepatch_699.call(this, GameplayEffectClass, GameplayEffectLevel, Stacks) }; } catch (e) {};
...
try { let fnprepatch_700 = MLAbilitySystemComponent.prototype.GetStat;MLAbilitySystemComponent.prototype.GetStat = function (StatType, StatGroup = "Base") { return fnprepatch_700.call(this, StatType, StatGroup) }; } catch (e) {};
...
try { let fnprepatch_701 = LevelVariantSetsActor.prototype.GetLevelVariantSets;LevelVariantSetsActor.prototype.GetLevelVariantSets = function (bLoad = false) { return fnprepatch_701.call(this, bLoad) }; } catch (e) {};
try { let fnprepatch_702 = AutomationUtilsBlueprintLibrary.prototype.TakeGameplayAutomationScreenshot;AutomationUtilsBlueprintLibrary.prototype.TakeGameplayAutomationScreenshot = function (ScreenshotName, MaxGlobalError = 0.019999999552965164, MaxLocalError = 0.11999999731779099, MapNameOverride) { return fnprepatch_702.call(this, ScreenshotName, MaxGlobalError, MaxLocalError, MapNameOverride) }; } catch (e) {};
try { let fnprepatch_703 = NUTActor.prototype.UnitTravel;NUTActor.prototype.UnitTravel = function (Dest = " ") { return fnprepatch_703.call(this, Dest) }; } catch (e) {};
try { let fnprepatch_704 = NUTActor.prototype.UnitSeamlessTravel;NUTActor.prototype.UnitSeamlessTravel = function (Dest = " ") { return fnprepatch_704.call(this, Dest) }; } catch (e) {};
...
try { let fnprepatch_705 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToTIFF;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToTIFF = function (SourceImage, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_705.call(this, SourceImage, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_706 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToPNG;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToPNG = function (SourceImage, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_706.call(this, SourceImage, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_707 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToJPEG;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToJPEG = function (SourceImage, Quality = 85, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_707.call(this, SourceImage, Quality, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
try { let fnprepatch_708 = AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToHEIF;AppleImageUtilsBaseAsyncTaskBlueprintProxy.prototype.CreateProxyObjectForConvertToHEIF = function (SourceImage, Quality = 85, bWantColor = true, bUseGpu = true, Scale = 1, Rotate = "None") { return fnprepatch_708.call(this, SourceImage, Quality, bWantColor, bUseGpu, Scale, Rotate) }; } catch (e) {};
...
try { let fnprepatch_709 = CableComponent.prototype.SetAttachEndToComponent;CableComponent.prototype.SetAttachEndToComponent = function (Component, SocketName = "None") { return fnprepatch_709.call(this, Component, SocketName) }; } catch (e) {};
try { let fnprepatch_710 = CableComponent.prototype.SetAttachEndTo;CableComponent.prototype.SetAttachEndTo = function (Actor, ComponentProperty, SocketName = "None") { return fnprepatch_710.call(this, Actor, ComponentProperty, SocketName) }; } catch (e) {};
...
try { let fnprepatch_711 = EditableMesh.prototype.EndModification;EditableMesh.prototype.EndModification = function (bFromUndo = false) { return fnprepatch_711.call(this, bFromUndo) }; } catch (e) {};
try { let fnprepatch_712 = SteamVRControllerLibrary.prototype.SetTouchDPadMapping;SteamVRControllerLibrary.prototype.SetTouchDPadMapping = function (NewMapping = "FaceButtons") { return fnprepatch_712.call(this, NewMapping) }; } catch (e) {};
try { let fnprepatch_713 = JavascriptGraphEditorLibrary.prototype.NodeCreator;JavascriptGraphEditorLibrary.prototype.NodeCreator = function (Graph, bSelectNewNode = true) { return fnprepatch_713.call(this, Graph, bSelectNewNode) }; } catch (e) {};
try { let fnprepatch_714 = JavascriptGraphEditorWidget.prototype.JumpToNode;JavascriptGraphEditorWidget.prototype.JumpToNode = function (JumpToMe, bRequestRename = false, bSelectNode = true) { return fnprepatch_714.call(this, JumpToMe, bRequestRename, bSelectNode) }; } catch (e) {};
try { let fnprepatch_715 = JavascriptGraphEdNode.prototype.GetNumOfPins;JavascriptGraphEdNode.prototype.GetNumOfPins = function (Direction = "EGPD_MAX") { return fnprepatch_715.call(this, Direction) }; } catch (e) {};
try { let fnprepatch_716 = JavascriptEditorEngineLibrary.prototype.SelectNone;JavascriptEditorEngineLibrary.prototype.SelectNone = function (Engine, bNoteSelectionChange, bDeselectBSPSurfs, WarnAboutManyActors = true) { return fnprepatch_716.call(this, Engine, bNoteSelectionChange, bDeselectBSPSurfs, WarnAboutManyActors) }; } catch (e) {};
try { let fnprepatch_717 = JavascriptEditorEngineLibrary.prototype.SelectGroup;JavascriptEditorEngineLibrary.prototype.SelectGroup = function (Engine, InGroupActor, bForceSelection = false, bInSelected = true, bNotify = true) { return fnprepatch_717.call(this, Engine, InGroupActor, bForceSelection, bInSelected, bNotify) }; } catch (e) {};
try { let fnprepatch_718 = JavascriptEditorEngineLibrary.prototype.SelectComponent;JavascriptEditorEngineLibrary.prototype.SelectComponent = function (Engine, Component, bInSelected, bNotify, bSelectEvenIfHidden = false) { return fnprepatch_718.call(this, Engine, Component, bInSelected, bNotify, bSelectEvenIfHidden) }; } catch (e) {};
try { let fnprepatch_719 = JavascriptEditorEngineLibrary.prototype.SelectActor;JavascriptEditorEngineLibrary.prototype.SelectActor = function (Engine, Actor, bInSelected, bNotify, bSelectEvenIfHidden = false, bForceRefresh = false) { return fnprepatch_719.call(this, Engine, Actor, bInSelected, bNotify, bSelectEvenIfHidden, bForceRefresh) }; } catch (e) {};
try { let fnprepatch_720 = JavascriptEditorEngineLibrary.prototype.CanSelectActor;JavascriptEditorEngineLibrary.prototype.CanSelectActor = function (Engine, Actor, bInSelected, bSelectEvenIfHidden = false, bWarnIfLevelLocked = false) { return fnprepatch_720.call(this, Engine, Actor, bInSelected, bSelectEvenIfHidden, bWarnIfLevelLocked) }; } catch (e) {};
try { let fnprepatch_721 = JavascriptEditorEngineLibrary.prototype.bspBrushCSG;JavascriptEditorEngineLibrary.prototype.bspBrushCSG = function (Engine, Actor, Model, PolyFlags, BrushType, CSGOper, bBuildBounds, bMergePolys, bReplaceNULLMaterialRefs, bShowProgressBar = true) { return fnprepatch_721.call(this, Engine, Actor, Model, PolyFlags, BrushType, CSGOper, bBuildBounds, bMergePolys, bReplaceNULLMaterialRefs, bShowProgressBar) }; } catch (e) {};
try { let fnprepatch_722 = JavascriptEditorLibrary.prototype.SetAlphamapDataFromMemory;JavascriptEditorLibrary.prototype.SetAlphamapDataFromMemory = function (LandscapeInfo, LayerInfo, MinX, MinY, MaxX, MaxY, PaintingRestriction = "None") { return fnprepatch_722.call(this, LandscapeInfo, LayerInfo, MinX, MinY, MaxX, MaxY, PaintingRestriction) }; } catch (e) {};
try { let fnprepatch_723 = JavascriptEditorLibrary.prototype.RemoveComponentFromBlueprint;JavascriptEditorLibrary.prototype.RemoveComponentFromBlueprint = function (Blueprint, RemoveComponent, bPromoteChildren = false) { return fnprepatch_723.call(this, Blueprint, RemoveComponent, bPromoteChildren) }; } catch (e) {};
try { let fnprepatch_724 = JavascriptEditorLibrary.prototype.ModifyObject;JavascriptEditorLibrary.prototype.ModifyObject = function (Object, bAlwaysMarkDirty = false) { return fnprepatch_724.call(this, Object, bAlwaysMarkDirty) }; } catch (e) {};
try { let fnprepatch_725 = JavascriptEditorLibrary.prototype.GetLayerInfoByName;JavascriptEditorLibrary.prototype.GetLayerInfoByName = function (LandscapeInfo, LayerName, Owner = undefined) { return fnprepatch_725.call(this, LandscapeInfo, LayerName, Owner) }; } catch (e) {};
try { let fnprepatch_726 = JavascriptEditorLibrary.prototype.GetDataTableAsJSON;JavascriptEditorLibrary.prototype.GetDataTableAsJSON = function (InDataTable, InDTExportFlags = 0) { return fnprepatch_726.call(this, InDataTable, InDTExportFlags) }; } catch (e) {};
try { let fnprepatch_727 = JavascriptEditorLibrary.prototype.GetAssetsByType;JavascriptEditorLibrary.prototype.GetAssetsByType = function (Types, bRecursiveClasses = true) { return fnprepatch_727.call(this, Types, bRecursiveClasses) }; } catch (e) {};
try { let fnprepatch_728 = JavascriptEditorLibrary.prototype.DeselectAll;JavascriptEditorLibrary.prototype.DeselectAll = function (Selection, InClass = null) { return fnprepatch_728.call(this, Selection, InClass) }; } catch (e) {};
try { let fnprepatch_729 = JavascriptEditorLibrary.prototype.Build;JavascriptEditorLibrary.prototype.Build = function (Builder, InWorld, InBrush = undefined) { return fnprepatch_729.call(this, Builder, InWorld, InBrush) }; } catch (e) {};
try { let fnprepatch_730 = JavascriptEditorLibrary.prototype.AddComponentsToBlueprint;JavascriptEditorLibrary.prototype.AddComponentsToBlueprint = function (Blueprint, Components, bHarvesting = false, OptionalNewRootComponent = undefined, bKeepMobility = false) { return fnprepatch_730.call(this, Blueprint, Components, bHarvesting, OptionalNewRootComponent, bKeepMobility) }; } catch (e) {};
try { let fnprepatch_731 = JavascriptPropertyCustomizationLibrary.prototype.AddExternalObjects;JavascriptPropertyCustomizationLibrary.prototype.AddExternalObjects = function (ChildBuilder, Objects, UniqueIdName = "None") { return fnprepatch_731.call(this, ChildBuilder, Objects, UniqueIdName) }; } catch (e) {};
try { let fnprepatch_732 = JavascriptPropertyCustomizationLibrary.prototype.AddExternalObjectProperty;JavascriptPropertyCustomizationLibrary.prototype.AddExternalObjectProperty = function (ChildBuilder, Objects, PropertyName, UniqueIdName = "None", bAllowChildrenOverride = false, bCreateCategoryNodesOverride = false) { return fnprepatch_732.call(this, ChildBuilder, Objects, PropertyName, UniqueIdName, bAllowChildrenOverride, bCreateCategoryNodesOverride) }; } catch (e) {};
